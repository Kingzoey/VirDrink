(function () {
   ...
   var scene=Laya.Scene3D.load("res/scenes3D/test1119/Conventional/MAX 1.ls",Laya.Handler.create(this,this.on_scene3d_loaded));
       ...
       onLoadSkyBox(mat)
       {
           ...
           //获取场景的天空渲染器
           var skyRenderer = this.actionScene.skyRenderer;
           //附上天空盒
